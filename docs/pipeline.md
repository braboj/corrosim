...
| **Libraries** | **pandas**: the summary / ranking table and the z-scored composite of gap / hardness / softness, blended across pH speciation (`src/corrosim/report/ranking.py`). |
